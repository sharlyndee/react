    ...
    <div class='container'>
       <div>
        <div className='row border border-dark mt-3 p-2 text-center'> 
            ...
            <div className='col-sm-2'> 
              <input type='text' name="tempName" placeholder='Product Name' onChange={ this.handleChange } value = {this.state.tempName}></input>
            </div>
            <div className='col-sm-2'> 
              <input type='text'name="tempDescription" placeholder='description'onChange={ this.handleChange }></input>
            </div>
            <div className='col-sm-2'> 
              <input type='text' name="tempPrice" placeholder='Price'onChange={ this.handleChange }></input>
            </div>
            <div className='col-sm-2'> 
              <input type='text' name="tempQuantity" placeholder='Quantity'onChange={ this.handleChange }></input>
            </div>
            <div className='col-sm-2'>
       ...
       {
         this.state.shopping.map(({name, id, picUrl, description, price, quantity}) => (
           <div>
           <MenuItem key={id} name={name} pic={picUrl} des={description} price={price} quantity={quantity} Increment={this.Increment} Decrement ={this.Decrement}></MenuItem>
          <div class='row'>
